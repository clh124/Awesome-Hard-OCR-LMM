...
|---|---|---|---|---|---|
| EMBLEM 🆕 | [EMBLEM](https://arxiv.org/abs/2609.08330v1) | arXiv 2026 | Table detection breaks on non-English scripts due to script diversity and scarce labels. MANDALA provides 2,323 pages across 18 languages and 15 scripts; EMBLEM masks script-specific cues so English-pretrained models focus on layout. English-only masked fine-tuning yields large cross-script gains. | `localization`, `table`, `multilingual` | [GitHub](https://github.com/IITB-LEAP-OCR/EMBLEM.git) |
...
| Full-Page OMR 🆕 | [Full-Page OMR](https://arxiv.org/abs/2609.05662v1) | arXiv 2026 | Full-page OMR Transformers fail on handwritten monophonic music. A synthetic generator emitting both styles lets the authors compare SMT against segmentation and unfolding pipelines on three corpora. Typeset pretraining matches handwritten pretraining; layout conventions trump visual similarity. | `formula`, `handwriting`, `layout` | - |
...
|---|---|---|---|
| URA Hackathon 2026 🆕 | Kaggle 2026 | Product names and text on social media images are hard to recognize. The URA Hackathon 2026 (Kaggle) features OCR and product name extraction from social media images, scored by Kaggle leaderboard. It releases a dataset and baselines for OCR-centric information extraction. | [Kaggle](https://www.kaggle.com/competitions/the-2nd-ura-hackathon) |
| KyrgyzANPR 🆕 | Kaggle 2026 | Number-plate recognition is challenging in regions with scarce training data and varied capture conditions. The Kaggle competition tasks teams with building OCR models for Kyrgyz license plates under uncontrolled real-world settings, evaluated on a held-out leaderboard. | [Kaggle](https://www.kaggle.com/competitions/kyrgyz-anpr-kyrgyz-license-plate-recognition-challenge) |
| StreetSmart Challenge 🆕 | Kaggle 2026 | Street scenes combine visual content with embedded text that pedestrians read and reason over. StreetSmart asks models to read street scenes, reason over OCR text, and answer real-world pedestrian questions accurately. A Kaggle leaderboard ranks systems on this OCR-grounded scene reasoning. | [Kaggle](https://www.kaggle.com/competitions/street-smart-challenge) |
...
| Sci-ImageMiner 🆕 | ICDAR 2026 Competition | ALD/E scientific figures encode dense hard-to-reuse quantitative info. Sci-ImageMiner (ICDAR 2026) runs classification, structured extraction, summarization, and VQA on real XPS spectra and phase diagrams, blind-tested in March 2026. It yields a leaderboard and dataset for figure understanding. | [Competition Website](https://sites.google.com/view/sci-imageminer/) |
